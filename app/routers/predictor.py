...
class Predictor:
    ...
    def analyze_packet(self, clf: DecisionTreeClassifier,clfrf:RandomForestClassifier,modelmlp:MLPClassifier,gnb:GaussianNB,modelgb:GradientBoostingClassifier,clf_knn:KNeighborsClassifier, raw_packet: str):
